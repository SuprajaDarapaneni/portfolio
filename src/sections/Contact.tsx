...
export default function Contact() {
  ...
  const contactMethods = [
    {
      ...
      icon: Mail,
      href: "mailto:veerapareddySupraja@gmail.com",
    ...
    },
    {
      ...
      icon: MessageCircle,
      href: "https://wa.me/918374330906?text=Hi%20Supraja%2C%20I%27d%20like%20to%20discuss%20a%20project%20with%20you",
      color: "from-black to-black",
    ...
    },
    {
      ...
      icon: Linkedin,
      href: "https://www.linkedin.com/in/Supraja-veerapareddy/",
      color: "from-black to-black",
    ...
    },
    {
      ...
      icon: Github,
      href: "https://github.com/Supraja-78",
      color: "from-black to-black",
  ...
  const handleCopyEmail = async () => {
    try {
      await navigator.clipboard.writeText("veerapareddySupraja@gmail.com");
      setCopiedEmail(true);
          ...
          >
            <div className="space-y-4">
              <div className="flex flex-col md:flex-row items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                <span>© {getCurrentYear()} Supraja . All rights reserved.</span>
